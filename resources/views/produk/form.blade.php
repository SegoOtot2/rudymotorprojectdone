  ...
  <div class="modal-dialog modal-lg" role="document">
    <form action="" method="post" class="form-horizontal">
      ...
      <div class="modal-body">
        ...
        <div class="form-group row">
            <label for="harga_jual_toko" class="col-md-2 col-md-offset-1 control-label">Harga Jual Toko</label>
            <div class="col-md-9">
                <input type="number" name="harga_jual_toko" id="harga_jual_toko" class="form-control">
                <span class="help-block with-errors"></span>
            </div>
        </div>
        <div class="form-group row">
