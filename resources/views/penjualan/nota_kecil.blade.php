...
<body onload="window.print()">
    ...
    <button class="btn-print" style="position: absolute; right: 1rem; top: rem;" onclick="window.close()">Close</button>
    ...
    <table width="100%" style="border: 0;">
        @foreach ($detail as $item)
            ...
            <tr>
                <td></td>
                <td></td>
                <td class="text-right">Diskon {{ $item->diskon }}% - {{ format_uang($item->diskon / 100 * $item->harga_jual * $item->jumlah) }}</td>
            </tr>
    @endif
        @endforeach
    </table>
    ...
    <script>
        ...
        document.cookie = "innerHeight="+ ((height + 5) * 0.264583);
